...
const AboutMe = () => {
  return (
        ...
        <div className='flex text-xl text-center gap-10 flex-col p-15 w-full h-full items-center  bg-sky-100'>
          <Card className='border flex flex-1 flex-col w-full '>
              <h3 className='bg-white w-120 underline decoration-sky-400 text-3xl'>Meet Me: Elijah Douglas!</h3>
              <p>give a little blurb about my journey
              </p>
            <div className='flex gap-6 mt-10 justify-center justify-start ml-19'>
              <img id="me" src={me} className='' alt='Profile Picture of Me' ></img>
            </div>
          </Card>
        ...
        <div className='flex flex-1 flex-col'>
          ...
          <ul>
            ...
            <li>Master the Cofing Interview: Data Structures + Algorithms, Andrei Neagoie</li>
